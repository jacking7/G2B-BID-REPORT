...
const setupSteps = [
  ...
  {
    title: "수신자 추가",
    body: "메일 리포트를 받을 이름과 이메일을 등록합니다. 활성 수신자가 있어야 신규 결과 메일을 보낼 수 있습니다.",
  },
  {
    title: "스케줄 저장",
...
const operationSteps = [
  {
    title: "실제 수집 실행",
    body: "공고 목록의 수동 작업에서 수집을 시작합니다. 진행률, 조회 건수, 일치 건수, 신규 저장 건수를 확인합니다.",
  },
  {
    title: "필터로 결과 확인",
    body: "날짜, 키워드, 메일 상태, 검색어로 결과를 좁혀 봅니다. 기본 조회일은 한국 시간 기준 오늘입니다.",
  },
  {
    title: "Excel 다운로드",
  ...
  {
    title: "신규 결과 메일 발송",
    body: "미발송 신규 결과를 Excel 첨부 메일로 보냅니다. 발송된 결과는 다시 중복 발송되지 않도록 상태가 갱신됩니다.",
  },
];
...
const statusNotes = [
  ...
  {
    term: "미발송 0건",
    description: "메일로 보낼 신규 결과가 없다는 뜻입니다. 새 수집을 실행한 뒤 다시 확인합니다.",
  },
];
